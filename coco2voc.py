...
if __name__ == '__main__':
    ...
    annotations_path = '/media/kisna/nano_ti_data1/DL_git/FLIRrgb_TFODAPI/flirRGB/train/thermal_annotations.json'

    # read coco category list
    df = pd.read_csv('/media/kisna/nano_ti_data1/DL_git/FLIRrgb_TFODAPI/flirRGB/coco_categories.csv')
    df.set_index('id', inplace=True)

    # specify image locations
    image_folder = '/media/kisna/nano_ti_data1/DL_git/FLIRrgb_TFODAPI/flirRGB/train'
