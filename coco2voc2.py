...
if __name__ == '__main__':
    label = 'train'
    annFolder = '/media/kisna/nano_ti_data1/DL_git/FLIRrgb_TFODAPI/flirRGB/train'

    # jsonPath = '../../../{}/landslide_{}_google_20191115.json'.format(label, label)
    jsonPath = '/media/kisna/nano_ti_data1/DL_git/FLIRrgb_TFODAPI/flirRGB/train/thermal_annotations.json'
